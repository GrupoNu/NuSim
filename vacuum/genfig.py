...
N, T, R1, R2, I1, I2 = np.loadtxt(sys.stdin, unpack=True)   # read data from standard input
P_num = R1**2 + I1**2
...
plt.title(r'Neutrino Oscillations - Constant Density, $N_e = e^1$')
plt.savefig(dir_path+"/fig/vacuum.png", dpi=300, format='png', bbox_inches="tight") # save figure in ./fig/vacuum.png
